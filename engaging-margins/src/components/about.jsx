...
export default function About() {
    return(
        ...
        <h1 className='text-5xl font-bold'>About</h1>
            ...
            <p className='text-3xl mb-10 mt-5'>This work is supported by the National Science Foundation (NSF) under grant <a className='text-secondary' href="https://www.nsf.gov/awardsearch/showAward?AWD_ID=2224674&HistoricalAwards=false">#2224674</a> and <a className='text-secondary' href="https://www.nsf.gov/awardsearch/showAward?AWD_ID=2224675&HistoricalAwards=false">#2224675</a>.</p>
