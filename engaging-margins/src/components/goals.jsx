...
export default function Goals() {
    return(
        ...
        <h1 className='text-5xl font-bold'>Project Goals</h1>
            <p className='text-2xl mt-5'>This study seeks to answer three main research questions:</p>
