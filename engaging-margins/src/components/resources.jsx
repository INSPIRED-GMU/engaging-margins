...
const Resources = () => {
    return (
        <div className='py-10 px-20'>
            ...
            <a href="https://github.com/INSPIRED-GMU/engaging-margins/main/engaging-margins/src/resources/ETM-survey.pdf" target="_blank" rel="noopener noreferrer" className='px-2.5'>
